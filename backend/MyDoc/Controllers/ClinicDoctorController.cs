...
namespace MyDoc.Controllers
{
    ...
    public class ClinicDoctorController(ClinicDoctorService Service) : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ClinicDoctorRequestDTO entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ClinicDoctorRequestDTO entity)
        {
