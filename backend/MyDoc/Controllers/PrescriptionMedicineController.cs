...
namespace MyDoc.Controllers
{
    ...
    public class PrescriptionMedicineController(PrescriptionMedicineService Service) : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PrescriptionMedicine entity)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] PrescriptionMedicine entity)
        {
